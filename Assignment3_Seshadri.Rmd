...
The residuals continue to show systemic funnel pattern when plotted against basement area, total living area and total rooms. The residuals are not strictly normal and is left skewed. 

```{r TranformMOdel, warning=F,echo=F,message=F,tidy=T,fig.cap='Multiple linear regression of Saleprice with categorical and continuous variables'}
...
plot(y = ComplexModel_Data$.resid, x = ComplexModel_Data$TotalBsmtSF, xlab = 'Total basement area', y= 'Residuals')
plot(y = ComplexModel_Data$.resid, x = ComplexModel_Data$GrLivArea, xlab = 'Above grade living area', y= 'Residuals')
plot(y = ComplexModel_Data$.resid, x = ComplexModel_Data$TotalBath, xlab = 'Total bathrooms', y= 'Residuals')
plot(y =ComplexModel_Data$.resid, x = ComplexModel_Data$Tier1, xlab = 'Tier 1 Neighborhood', y= 'Residuals')
plot(y =ComplexModel_Data$.resid, x = ComplexModel_Data$Tier2, xlab = 'Tier 2 Neighborhood', y= 'Residuals')
plot(y =ComplexModel_Data$.resid, x = ComplexModel_Data$Tier3, xlab = 'Tier 3 Neighborhood', y= 'Residuals')
plot(y =ComplexModel_Data$.resid, x = ComplexModel_Data$Tier4, xlab = 'Tier 4 Neighborhood', y= 'Residuals')
