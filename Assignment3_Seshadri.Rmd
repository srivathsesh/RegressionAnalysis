...
The below table shows the results of multiple linear regression model **SalePRice = 7.17e+04 + 5.681e+01*TotalBsmtSF + 6.3e+01*GrLivArea + 8.22e-01*LotArea + 1.11e+04*TotalBath - 1.14e+05*Tier1 - 9.57e+04*Tier2 - 7.44e+04*Tier3 - 2.9e+04* Tier4** using the above predictors. All the partial regression coefficients are statistically significant at 95% significance level (P value <<< 0.05). The overall regression effect is also statistically significant with F statistic = 702 and adjusted R squared at 80%. <br>
...
A multiple linear regression model of logarthimically transformed Sale price is fit. Below are the results for the model ***Log(Sale Price) = 4.979e+00 + 1e-04*TotalBsmtSF + 1.236e-04*GrLivArea + 1.251e-06*LotArea + 2.809e-02*TotalBath - 2.160e-01*Tier1 - 1.585e-01*Tier2 - 9.391e-02*Tier3 - 2.740e-02*Tier4***. The partial regression coefficients are statistically signiticant at 95% significance, with P values <<< 0.05. The overall regression is signiticant with F statistic at 796. The Adjusted-R-Squared value is 82%. The residuals are more normal than the non-transformed sale price and the residuals do not have as much as a pattern like it did in the model without transformation of sale price.The residuals are less hetroscedastic. The models are comapred in the next section.
...
To address the skewness in Lot Area, the lot area was logarithmically transformed and a multiple linear regression model was fit. Below are the results of the model ***Log(Sale Price) = 4.716e+00 + TotalBsmtSF*1.037e-04 + GrLivArea*1.181e-04 + log(LotArea)*7.309e-02 + TotalBath*2.847e-02 - Tier1*2.180e-01 - Tier2*1.654e-01 - Tier3*9.951e-02 - Tier4*3.200e-02***. It is seen that the partial regression coefficients are stastically significant at 95% significance and so is regression effect with F statistic at 812. The residuals are skewed left, but is fairly normal and they show a funnel shape behavior with Lot area. <br>
